...
Created file prestashop-mastercard.zip contains the distributable code for this module.
...
Upload the prestashop-mastercard.zip into the designated area in the release edit page.
